        ...
        <div className="w-full max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-start items-center justify-center gap-8">
            ...
            <div className="w-full flex-1 flex flex-col items-center gap-8">
              {/* Wheel Section */}
              <div
                className="w-full max-w-[min(100vw,600px)] aspect-square relative flex items-center justify-center cursor-pointer"
                onClick={handleSpin}
              >
                ...
                <div className="absolute inset-0 grid grid-cols-8 gap-x-0.5 mr-[10%] ml-[3%] my-[4%]">
                  ...
                  <div className="col-span-7 grid grid-cols-7 gap-x-0.5">
                    ...
                    <div className="grid grid-rows-3 gap-y-0.5">
                      <div
                        data-number="1"
                        className="cursor-pointer hover:bg-white/10 transition-colors relative h-full"
                        onClick={() => handleNumberClick('1')}
                      >
                        {bets['1'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['1']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                                  style={{
                      ...
                      >
                        {bets['10'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['10']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                      ...
                      >
                        {bets['16'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['16']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                    ...
                    <div className="grid grid-rows-3 gap-y-0.5">
                      ...
                      >
                        {bets['17'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['17']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                      ...
                      >
                        {bets['20'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['20']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                    ...
                    <div className="grid grid-rows-3 gap-y-0.5">
                      ...
                      >
                        {bets['14'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['14']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                      ...
                      >
                        {bets['11'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['11']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                    ...
                    <div className="grid grid-rows-3 gap-y-0.5">
                      ...
                      >
                        {bets['12'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['12']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                      ...
                      >
                        {bets['21'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['21']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                      ...
                      >
                        {bets['19'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['19']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                    ...
                    <div className="grid grid-rows-3 gap-y-0.5">
                      ...
                      >
                        {bets['18'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['18']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                    ...
                    <div className="grid grid-rows-3 gap-y-0.5">
                      ...
                      >
                        {bets['15'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['15']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                      ...
                      >
                        {bets['13'] && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            {getChipCombination(bets['13']).map(
                              (chipValue: number, index: number) => (
                                <div
                                  key={index}
                                  className="absolute"
                  ...
                  <div className="col-span-1">
                    ...
                    >
                      {bets['00'] && (
                        <div className="absolute inset-0 flex items-center justify-center">
                          {getChipCombination(bets['00']).map(
                            (chipValue: number, index: number) => (
                              <div
                                key={index}
                                className="absolute"
