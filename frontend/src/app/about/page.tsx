    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-4 pt-16 md:pt-20">
        <div className="w-full md:max-w-6xl mx-auto px-2 md:px-0">
          <h1
            className={`text-3xl md:text-6xl text-white font-bold mb-6 md:mb-8 ${daydream.className}`}
          >
            About kzyno
          </h1>
            ...
            <section className="max-w-sm mx-auto md:max-w-none w-full bg-[#2a0a1f] p-3 md:p-6 rounded-xl md:rounded-2xl border-2 border-[#ff69b4] shadow-[0_0_30px_rgba(255,20,147,0.3)] md:sticky md:top-8">
              ...
              <div className="space-y-4">
                <p className="text-pink-100 leading-relaxed">
                  this is a decentralized casino. it&apos;s not owned by a company, a person, or any
                  central entity. it&apos;s just code—open, transparent, and running on the
                  blockchain. anyone can interact with it, from anywhere, without permission. no
                  gatekeepers, no middlemen. just the game, as it should be.
                </p>
                <p className="text-pink-100 leading-relaxed">
                  but it&apos;s more than that. when you play here, you&apos;re not just a player.
                  you can own a piece of the casino itself. through tokens, you become a
                  stakeholder. and as a stakeholder, you share in the profits. all of them. the
                  contract is designed to return everything to the token holders. no cuts, no
                  skimming, no hidden fees. just a direct flow of value back to the people who are
                  part of it.
                </p>
                <p className="text-pink-100 leading-relaxed">
                  this flips the script. traditionally, the house always wins, and players are left
                  with nothing. here, the players are the house. the line between the two
                  disappears. it&apos;s a fairer system, one where the incentives align with the
                  community, not some distant corporation.
                </p>
                <p className="text-pink-100 leading-relaxed">
                  it&apos;s not about reinventing gambling. it&apos;s about rethinking who benefits
                  from it. this is a casino where transparency and ownership are built into the
                  foundation. where the rules are clear, the code is open, and the value flows back
                  to the people who make it work.
                </p>
                <p className="text-pink-100 leading-relaxed">
                  this isn&apos;t just a casino. it&apos;s a different way of doing things. one
                  where freedom isn&apos;t an abstract idea—it&apos;s how the system operates.
                </p>
              </div>
