  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-[#2a0a1f] border-2 border-[#ff69b4] rounded-2xl p-6 max-w-md w-full shadow-[0_0_30px_rgba(255,20,147,0.3)]">
        <h2 className={`text-2xl text-white mb-6 text-center ${daydream.className}`}>
          Sign Up for Airdrop
        </h2>

        <form onSubmit={handleSubmit} className={`space-y-4 ${hyperlegible.className}`}>
          <div>
            <label htmlFor="email" className={`block text-pink-200 mb-1 ${daydream.className}`}>
              Email
            </label>
            <input
              type="email"
          ...
          <div>
            <label htmlFor="wallet" className={`block text-pink-200 mb-1 ${daydream.className}`}>
              Wallet Address
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="twitter" className={`block text-pink-200 mb-1 ${daydream.className}`}>
          ...
          <div>
            <label htmlFor="discord" className={`block text-pink-200 mb-1 ${daydream.className}`}>
        ...
        {submitStatus === 'success' && (
          <div
            className={`mt-4 p-2 bg-green-500 bg-opacity-20 border border-green-500 rounded text-green-300 text-center ${hyperlegible.className}`}
          >
        ...
        {submitStatus === 'error' && (
          <div
            className={`mt-4 p-2 bg-red-500 bg-opacity-20 border border-red-500 rounded text-red-300 text-center ${hyperlegible.className}`}
          >
            {errorMessage}
          </div>
        )}
